...
import com.cloriko.PodRegistry.{ Join, PodInfo, PodRegistered }
import com.cloriko.UserRegistryActor.{ UserAlreadyExisted, UserCreated, UserInfo }
...
object PodRegistry {
  ...
  abstract class PodRegistryRequest(val username: String)
