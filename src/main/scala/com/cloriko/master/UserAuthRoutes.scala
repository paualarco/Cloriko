...
import com.cloriko.UserRegistryRequest
import com.cloriko.master.ActorSystemShape
import com.cloriko.master.UserRegistryActor.{UserAlreadyExisted, UserCreated}
...
trait UserAuthecnticationRoutes extends JsonSupport {
        ...
        concat(
          ...
          post {
            entity(as[UserRegistryRequest]) { userRegistryRequest =>
              ...
              val future = (userRegistry ? userRegistryRequest)
              onSuccess(future) {
